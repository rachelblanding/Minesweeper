...
public class number extends JFrame{
	...
	public void zeroNumbers(int x, int y, int xAxis, int yAxis) {
		...
		/*if(x!=(x-1)) {
				if(y!=0) {
					if(boardArr[x+1][y-1].getText().equals("  0  ")) {
						clearArr[x+1][y-1].setVisible(false);
						boardArr[x+1][y-1].setVisible(true);
					}
				}
				if(boardArr[x+1][y].getText().equals("  0  ")) {
					clearArr[x+1][y].setVisible(false);
					boardArr[x+1][y].setVisible(true);
				}
				if(y!=(y-1)) {
					if(boardArr[x+1][y+1].getText().equals("  0  ")) {
						clearArr[x+1][y+1].setVisible(false);
			...
			if(y!=0) {
				if(boardArr[x][y-1].getText().equals("  0  ")) {
					clearArr[x][y-1].setVisible(false);
					boardArr[x][y-1].setVisible(true);
				}
			}
			if(y!=(y-1)) {
				if(boardArr[x][y+1].getText().equals("  0  ")) {
